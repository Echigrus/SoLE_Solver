...
namespace Matrices
{
    partial class AboutBox1 : Form
    {
        public AboutBox1()
        {
            ...
            this.labelVersion.Text = "Версия 1.1.2";
            this.labelCopyright.Text = "Автор: Дмитрий Андреев";
            this.labelCompanyName.Text = "Echigrus | HansaDev Team";
            this.textBoxDescription.Text = "Данная программа написана в рамках проектной работы для Конкурса «Я и Земля» 2018-2019 года. Назначение: " +
